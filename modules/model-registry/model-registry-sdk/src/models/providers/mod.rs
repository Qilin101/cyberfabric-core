...
//!        dir_path = "schemas",
//!        base = ModelInfoV1,
//!        schema_id = "gts.cf.genai.model.info.v1~<vendor>.<package>.<name>.v<n>~",
...
//! carries its `provider_settings` as
//! [`crate::models::RawProviderSettings`] (i.e. raw JSON), and operators can
//! wire up routing without an SDK release.
